...
from myproject import db, bcrypt, app, mail
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='noreply@theinfoblog1.com', recipients=[user.email])
    msg.body = f'''To reset your password, visit the following link:
{url_for('reset_token', token=token, _external=True)}

If you did not make this request then simply ignore this email and no chachanges will be made.
'''
    mail.send(msg)


# message = Mail(
#     from_email='theinfoblog1@gmail.com',
#     to_emails='[user.email]',
#     subject='Password Reset Request',
#     html_content=f'''To reset your password, visit the following link:
# {url_for('reset_token', token=user.get_reset_token(), _external=True)}
